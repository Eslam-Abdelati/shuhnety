  ...
  const faqs = [
    {
      ...
      answer:
        "شحنتي هي أول منصة لوجستية متكاملة مصممة لربط التجار وسلاسل التوريد بالكباتن وشركات النقل عبر نظام مزايدة حي وشفاف. تضمن المنصة الأمان، السرعة، والتحصيل الرقمي العادل لجميع أطراف المنظومة.",
    },
    {
      category: "merchants",
    ...
    },
    {
      ...
      answer:
        "بالتأكيد، منصة شحنتي تمنح الكباتن حرية كاملة في اختيار الشحنات التي تناسب مساراتهم وأوقاتهم، مما يساعدهم على زيادة دخلهم في الوقت الذي يفضلونه.",
    },
  ];
