    ...
    const faqs = [
        {
            ...
            answer: 'شحنتي هي أول منصة لوجستية متكاملة مصممة لربط التجار وسلاسل التوريد بالكباتن وشركات النقل عبر نظام مزايدة حي وشفاف. تضمن المنصة الأمان، السرعة، والتحصيل الرقمي العادل لجميع أطراف المنظومة.'
        },
        {
            category: 'merchants',
            question: 'كيف يمكنني البدء كتاجر أو صاحب بضاعة؟',
            answer: 'يمكنك البدء بإنشاء حساب "تاجر"، ثم إضافة تفاصيل شحنتك (نوع البضاعة، الوزن، المسار). ستبدأ فوراً في استقبال عروض أسعار تنافسية من كباتن موثقين، ويمكنك اختيار العرض الأنسب لك بعد التفاوض.'
        },
        {
            category: 'drivers',
        ...
        },
        {
            ...
            answer: 'بالتأكيد، منصة شحنتي تمنح الكباتن حرية كاملة في اختيار الشحنات التي تناسب مساراتهم وأوقاتهم، مما يساعدهم على زيادة دخلهم في الوقت الذي يفضلونه.'
        }
    ]
