    ...
    const sections = [
        {
            ...
            icon: FileText,
            content: 'منصة شحنتي هي وسيط تقني يربط بين طالبي خدمات النقل (التجار/العملاء) ومقدمي خدمات النقل (السائقين/شركات النقل). المنصة لا تملك مركبات ولا تعمل كشركة نقل مباشرة، بل كمنصة لإدارة العمليات اللوجستية.'
        },
        {
            title: '2. شروط التسجيل والحساب',
            icon: Lock,
            content: 'يجب أن تكون كافة البيانات المقدمة أثناء التسجيل دقيقة ومحدثة. بالنسبة للسائقين، يجب توفير رخصة قيادة سارية، أوراق المركبة، وأي مستندات قانونية تطلبها المنصة للتحقق من الأهلية.'
        },
        {
            title: '3. نظام المزايدة والتفاوض',
            icon: ArrowRight,
            content: 'تعتمد المنصة نظام المزايدة الحر، حيث يقدم السائقون عروضاً سعرية بناءً على تفاصيل الشحنة. يحق للعميل التفاوض لمرة واحدة أو أكثر، وبمجرد قبول العرض، يُعد ذلك التزاماً تعاقدياً بين الطرفين.'
        },
        {
        ...
        },
        {
            ...
            icon: Shield,
            content: 'تضمن المنصة سرية البيانات وتتبع الشحنات، ولكن لا تتحمل المسؤولية المباشرة عن أي أضرار مادية تلحق بالبضائع أثناء النقل، حيث تقع المسؤولية على عاتق السائق/شركة النقل وفقاً للقوانين المصرية المعمول بها.'
        },
        {
