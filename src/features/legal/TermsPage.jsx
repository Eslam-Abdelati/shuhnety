    ...
    >
      ...
      <div className="relative bg-lp-on-background py-24 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10 text-center">
          ...
          >
            يرجى قراءة شروط استخدام منصة شحنتي بعناية لضمان تجربة آمنة وعادلة
            للجميع
          </motion.p>
        </div>
      </div>
        ...
        >
          ...
          <div className="mb-12">
            ...
            <p>
              ...
              بين منصة "شُحنتي" الإلكترونية (المشار إليها لاحقاً بـ "المنصة" أو
          ...
          <div className="mt-20 pt-10 border-t text-center">
            <p className="text-sm mb-8">
              بإنشائك حساباً في منصة شحنتي، فإنك توافق ضمنياً على كافة البنود
              المذكورة أعلاه.
            </p>
          </div>
        </motion.div>
